...
import com.exercise3.service.RoleService;
...
public class AdminController {
    ...
    public String editUser(@PathVariable Long id, @ModelAttribute("updateUserDto") UpdateUserDto dto, BindingResult br, Model model)
    {
